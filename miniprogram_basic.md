...
<table>
    ...
    <tr>
        <td>注册方式<br/>政府类型需要通过微信认证确认主体真实性，在认证完成前小程序部分能力暂不支持。<a href="http://kf.qq.com/faq/120911VrYVrA1609073yqMzm.html">详见</a></td>
    </tr>
    <tr>
        <td rowspan="4">媒体</td> 
